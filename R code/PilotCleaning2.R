...
setwd("~/Documents/Projects/FYP/Pilot_Data/Individual data files")

#read in all the individual output files
#how to do this in a loop?
Sub1 = read.delim("Sub1.txt", header = T, stringsAsFactors=F)
Sub2 = read.delim("Sub2.txt", header = T, stringsAsFactors=F)
Sub3 = read.delim("Sub3.txt", header = T, stringsAsFactors=F)
Sub4 = read.delim("Sub4.txt", header = T, stringsAsFactors=F)
Sub5 = read.delim("Sub5.txt", header = T, stringsAsFactors=F)
Sub6 = read.delim("Sub6.txt", header = T, stringsAsFactors=F)
Sub7 = read.delim("Sub7.txt", header = T, stringsAsFactors=F)
Sub8 = read.delim("Sub8.txt", header = T, stringsAsFactors=F)
Sub9 = read.delim("Sub9.txt", header = T, stringsAsFactors=F)
Sub10 = read.delim("Sub10.txt", header = T, stringsAsFactors=F)
Sub11 = read.delim("Sub11.txt", header = T, stringsAsFactors=F)
Sub12 = read.delim("Sub12.txt", header = T, stringsAsFactors=F)
Sub13 = read.delim("Sub13.txt", header = T, stringsAsFactors=F)
Sub14 = read.delim("Sub14.txt", header = T, stringsAsFactors=F)
Sub15 = read.delim("Sub15.txt", header = T, stringsAsFactors=F)
Sub16 = read.delim("Sub16.txt", header = T, stringsAsFactors=F)
Sub17 = read.delim("Sub17.txt", header = T, stringsAsFactors=F)
Sub18 = read.delim("Sub18.txt", header = T, stringsAsFactors=F)
Sub19 = read.delim("Sub19.txt", header = T, stringsAsFactors=F)
Sub20 = read.delim("Sub20.txt", header = T, stringsAsFactors=F)
Sub21 = read.delim("Sub21.txt", header = T, stringsAsFactors=F)
Sub22 = read.delim("Sub22.txt", header = T, stringsAsFactors=F)
Sub23 = read.delim("Sub23.txt", header = T, stringsAsFactors=F)
Sub24 = read.delim("Sub24.txt", header = T, stringsAsFactors=F)
Sub25 = read.delim("Sub25.txt", header = T, stringsAsFactors=F)
Sub26 = read.delim("Sub26.txt", header = T, stringsAsFactors=F)
Sub27 = read.delim("Sub27.txt", header = T, stringsAsFactors=F)
...
for (i in 1:27) {
  fileName = paste("./Individual data files/Sub", i, ".txt", sep="") # make filename. Numeric i is coerced to string
...
# see alternative way to fix fixation from Joe farther down
require(stringr)
...
### better way to do fixation from Joe
forehead_range = c(1:8)
eyes_range = c(9:16)
nose_range = c(17:24)
